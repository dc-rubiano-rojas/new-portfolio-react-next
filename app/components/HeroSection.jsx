    ...
    <section className="relative overflow-hidden py-20 lg:py-28 bg-gradient-to-b from-[#0b0b0b] via-[#111] to-[#1a1a1a]">
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-10 relative z-10 items-center">
        ...
        >
          ...
          <p className="text-gray-300 text-base sm:text-lg lg:text-xl mb-8 max-w-2xl mx-auto md:mx-0">
        ...
        >
          <div className="relative w-[220px] h-[220px] sm:w-[280px] sm:h-[280px] md:w-[340px] md:h-[340px] lg:w-[420px] lg:h-[420px] bg-gradient-to-tr from-purple-600 to-blue-500 p-[3px] rounded-full shadow-lg shadow-blue-500/20">
            <div className="relative w-full h-full rounded-full bg-[#0b0b0b] flex items-center justify-center overflow-hidden">
              <Image
